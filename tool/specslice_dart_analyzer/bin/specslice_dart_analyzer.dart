/// Entry point for the SpecSlice Dart analyzer sidecar.
///
/// Usage:
///   dart run specslice_dart_analyzer --request /path/to/request.json
...
Future<int> main(List<String> argv) async {
  ...
  if (args['help'] as bool) {
    stdout.writeln('Usage: specslice_dart_analyzer [--request FILE]');
    return 0;
  }

...
//!
//! SpecSlice already stores rich provenance on each edge:
...
use specslice_core::edge::{EdgeAssertion, EdgeCertainty, EdgeKind, EdgeSource, EdgeStatus};
...
mod tests {
    ...
    fn confidence_for_edge_wraps_derive_correctly() {
        let mut edge = EdgeAssertion::fact(
            specslice_core::ArtifactId::new("a"),
            specslice_core::ArtifactId::new("b"),
            EdgeKind::Calls,
            EdgeSource::LanguageAdapter,
        );

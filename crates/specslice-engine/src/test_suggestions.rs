...
//!
//! A rewrite needs tests, and the facts SpecSlice already extracts say
...
fn numeric_boundaries(raw: &str, lang: specslice_core::language_traits::Language) -> Vec<String> {

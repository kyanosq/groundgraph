//! P1 integration tests: `specslice connect propose / apply` engine surface.
//!
...
//!   `.specslice/links.yaml`. No rule matching may invent business links.

use std::path::Path;

use specslice_engine::connect::{apply_candidates, propose_evidence, ApplyOptions, ApplyOutcome};

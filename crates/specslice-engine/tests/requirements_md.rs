...
//!
//! Proves the recommended `.specslice/requirements/*.md` format flows through
...
use specslice_engine::config::DEFAULT_CONFIG_FILE_NAME;
...
fn fixture() -> TempDir {
    ...
    std::fs::remove_dir_all(root.join(".specslice/requirements")).ok();
    ...
    write(
        root,
        ".specslice/requirements/0001-demo.md",
        "# REQ-DEMO 演示需求\n\
         \n\
         演示用需求，描述意图。\n\
         \n\

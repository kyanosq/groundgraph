//! `specslice graph-diff` — P19 graph snapshot diff.

use std::path::PathBuf;

use anyhow::{Context, Result};
use specslice_engine::graph_diff::{diff_graphs, GraphDiff, GraphDiffOptions};
...
pub struct GraphDiffRunArgs {
    ...
    /// pulled from `.specslice/candidates/business_logic.yaml`.
...
fn print_text(r: &GraphDiff) {
    ...
    {
        println!(
            "\n业务候选 (.specslice/candidates/business_logic.yaml): base {} → head {} (+{} / -{} / 状态 {})",

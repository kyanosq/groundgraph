...
//!
//! The MVP parser only records declarations. To make `groundgraph graph
...
use groundgraph_core::language_batch::{ReferenceEdge, SymbolArtifact, SymbolRange};
...
mod tests {
    use super::*;
    use groundgraph_core::artifact_id::{dart_class_id, dart_method_id};
    use groundgraph_core::language_batch::SymbolArtifact;
    ...
    fn class_symbol_skips_body_scan_entirely() {
        ...
        let test = SymbolArtifact {
            id: groundgraph_core::artifact_id::dart_test_id("lib/x_test.dart", "named"),

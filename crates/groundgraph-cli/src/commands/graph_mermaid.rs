//! Mermaid serializer for `groundgraph graph --format mermaid` and the
...
use groundgraph_engine::graph::{GraphLayer, GraphViewModel};
...
mod tests {
        ...
        GraphViewModel {
            ...
            nodes: vec![
                GraphNode {
                    ...
                    column: groundgraph_engine::graph::GraphColumn::Documents,
                ...
                GraphNode {
                    ...
                    column: groundgraph_engine::graph::GraphColumn::Business,
    ...
    fn truncation_note_appears_when_finding_present() {
        let mut v = view();
        v.findings.push(groundgraph_engine::graph::GraphFinding {

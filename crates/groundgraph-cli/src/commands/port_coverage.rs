//! `groundgraph port-coverage` — porting coverage ledger (P24 gap #4).
//!
...
//!
//! ```text
//! groundgraph port-coverage --source-db old/.groundgraph/graph.db \
//!                         --target-db new/.groundgraph/graph.db
//! groundgraph port-coverage --source-db a.db --target-db b.db --json
//! ```

use std::path::PathBuf;

use anyhow::{Context, Result};
use groundgraph_engine::port_coverage::{

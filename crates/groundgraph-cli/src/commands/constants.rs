//! `groundgraph constants` — constants & literals catalogue (P24 gap #2).
//!
//! ```text
//! groundgraph constants                       # magic ints/floats/strings, most-repeated first
//! groundgraph constants --kind str            # only string literals
//! groundgraph constants --min-occurrences 3   # values that repeat ≥3 times
//! groundgraph constants --json                # machine-readable for an agent
//! ```

use std::path::PathBuf;

use anyhow::{Context, Result};
use groundgraph_engine::constants::{

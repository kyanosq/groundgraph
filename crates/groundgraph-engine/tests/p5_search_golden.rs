//! P5 — `groundgraph search` golden regression against PixCraft fixture.
//!
...
use groundgraph_engine::business_candidates::{apply_review, ReviewStatus, ReviewVerdict};
...
fn setup_indexed_repo() -> Option<tempfile::TempDir> {
    common::setup_indexed_dart_repo("p5_search_golden", "pixcraft_iap", &["lib", "test"])
}

//! P24 — Business documentation export (`groundgraph business-doc`).
//!
//! This is the *back half* of "build business documentation from code".
//! The pipeline is:
//!
//! ```text
//! groundgraph propose            -> evidence pack + prompt (business_pack.rs)
//!   -> AI writes business_logic.yaml   (grounded in the pack)
//!   -> groundgraph candidate review      (human accepts / rejects)
//!   -> groundgraph business-doc          (this module: accepted claims ->

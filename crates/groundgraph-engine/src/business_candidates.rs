...
//! `.groundgraph/candidates/business_logic.yaml`. Each candidate carries:
//!
...
pub const BUSINESS_CANDIDATES_REL_PATH: &str = ".groundgraph/candidates/business_logic.yaml";
...
pub struct BusinessCandidate {
    ...
    /// only the `groundgraph candidate review` command does. Round-trips
...
pub fn apply_review(
    ...
    // the write, so two concurrent `groundgraph candidate review` processes (CI)
...
"#,
    ...
    fn apply_review_is_serialized_across_concurrent_reviewers() {
        ...
        // two concurrent `groundgraph candidate review` processes (CI) could each

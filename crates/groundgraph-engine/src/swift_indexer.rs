...
pub const SWIFT_LSP_COMMAND_ENV: &str = "GROUNDGRAPH_SWIFT_LSP_BIN";

pub fn swift_lsp_command_env() -> Option<String> {
    std::env::var(SWIFT_LSP_COMMAND_ENV).ok()
}
...
mod tests {
    ...
    fn swift_lsp_available_respects_override_and_path() {
        ...
        let opts = SwiftIndexOptions {
            ...
            lsp_command: Some("groundgraph_nonexistent_swift_lsp_999".into()),
        };

...
use groundgraph_core::language_traits::{language_of, lex_syntax, Language};
...
/// loaded N-up and can OOM `groundgraph index`. Files over this are skipped.
...
mod tests {
    ...
    fn read_node_source_skips_oversized_files() {
        ...
        // an unguarded read can OOM `groundgraph index` (parity with the
